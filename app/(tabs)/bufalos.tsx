...
export default function Bufalos() {
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: RFValue(30) }}>
        ...
        <View style={{width: width, alignItems: "center", marginTop: RFValue(10)}}>
          <View style={{ marginBottom: RFValue(10) }}>
            <CardBuffalo text_tag={"#9999"} text_name={"Luna"} text_sex={"Fêmea"} text_grupo={"Gurpo A"} text_localizacao={"Lote 1"} text_maturidade={"Vaca"} text_nascimento={"11/02/2005"} text_prodLeite={"8.5 L"} text_saude={"Saudável"}></CardBuffalo>
          </View>
          <View style={{ marginBottom: RFValue(10) }}>
            <CardBuffalo text_tag={"#9999"} text_name={"Luna"} text_sex={"Fêmea"} text_grupo={"Gurpo A"} text_localizacao={"Lote 1"} text_maturidade={"Vaca"} text_nascimento={"11/02/2005"} text_prodLeite={"8.5 L"} text_saude={"Saudável"}></CardBuffalo>
          </View>
  ...
  <ModalCustom visible={modalVisible} onClose={() => setModalVisible(false)} title={"Cadastrando um novo Bubalino"}>
    ...
    <View style={{ flexDirection: "row", gap: RFValue(10), marginBottom: RFValue(20), zIndex: 1000 }}>
      {/* Select de Sexo */}
