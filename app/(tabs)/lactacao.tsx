...
import CardLactacao from "../../src/components/ui/cardLactacao";
  ...
  return (
    <SafeAreaView style={{ flex: 1, alignItems: "center"}}>
      <ScrollView contentContainerStyle={{ paddingBottom: RFValue(30)}}>
        <View style={{width: width, height: height*0.17, alignItems: "center", justifyContent:"center", marginTop: RFValue(30)}}>
          <TextoTitle>Produção da propriedade:</TextoTitle>
          <LayoutSex>
            <CardSex title="Produzido" contador="3 L." showIcon={false}></CardSex>
            <CardSex title="Retirado" contador="2 L." showIcon={false}></CardSex>
          </LayoutSex>
        </View>
        <View style={{width: width, height: height*0.1, alignItems: "center", justifyContent:"center" }}>
          <BarSearch />
        </View>
        <View style={{width: width,  height: height*0.63, alignItems: "center"}}>
              <CardLactacao
                text_tag={"#9999"}
                text_name={"Luna"}
