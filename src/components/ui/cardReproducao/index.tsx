...
export default function CardReproducao({
  text_tag,
  text_name,
  text_gestacao,
  desc_gesta,
  ...
  return (
    <>
      ...
      <ModalCustom visible={modalVisible} onClose={() => setModalVisible(false)} title={"Atualizar Status Reprodutivo:"}>
        ...
        <View style={{ flexDirection: "column", gap: RFValue(10), marginBottom: RFValue(30) }}>
          <TouchableOpacity
            ...
            style={{
              ...
              width: width * 0.88, height: height * 0.05
            }}
          >
            <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'center'}}>
                <TextBody variant="secondary">
                    {showAdditional ? "Informações Adicionais " : "Informações Adicionais "} 
                </TextBody>
                    <Entypo name={showAdditional ? "chevron-small-up" : "chevron-small-down"} size={30} color="#333" />
            </View>
          </TouchableOpacity>

          {showAdditional && (
            <View style={{ flexDirection: "column", gap: RFValue(25), marginBottom: RFValue(30) }}>
                <View style={{ flexDirection: "column", width: width * 0.88, height: height * 0.05 }}>
